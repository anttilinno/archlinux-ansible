...
| `common_i3_enabled` | `false` | xorg-server, xorg-xinit, i3-wm, polybar, rofi, wezterm, xclip, flameshot (+ AUR: xkb-switch, i3lock-color) |
...
| `common_aur_enabled` | `false` | shellcheck-bin, zen-browser-bin |
